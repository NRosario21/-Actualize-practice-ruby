...
while true
  ...
  get_string = "https://api.openweathermap.org/data/2.5/weather?q=" + input_city + "&units=" + unit + "&appid=97c0808076d9312acf3a18af26fa85c0"
  response = HTTP.get(get_string)   #("https://api.openweathermap.org/data/2.5/weather?q=Chicago&units=imperial&appid=97c0808076d9312acf3a18af26fa85c0")
